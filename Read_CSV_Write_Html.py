...
writeIndexFile.write(" \n")
writeIndexFile.write('<script src="http://maps.googleapis.com/maps/api/js?libraries=geometry&key=YOURKEYHERE"></script> \n')
writeIndexFile.write(" \n")
...
for filename in filenames:
    ...
    writeHTMLfile.write(" \n")
    writeHTMLfile.write('<script src="http://maps.googleapis.com/maps/api/js?libraries=geometry&key=YOURKEYHERE"></script> \n')
    writeHTMLfile.write(" \n")

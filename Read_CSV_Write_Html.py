...
writeIndexFile.write('<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /> \n')
writeIndexFile.write('<meta http-equiv="Pragma" content="no-cache" /> \n')
...
writeIndexFile.write(" \n")
writeIndexFile.write('<script src="http://maps.googleapis.com/maps/api/js?libraries=geometry&key=YOURKEYGOESHERE"></script> \n')
writeIndexFile.write(" \n")
...
rightfile.write("</style> \n")
rightfile.write("</head> \n")
rightfile.write("<body> \n")
rightfile.write(' \n')
rightfile.write('<h4>Connections Seen: <a href="/logs/" target="logs"> Click for logs</a> &nbsp; &nbsp; <a href="/maps/" target="maps"> Click for saved maps</a></br> \n')
rightfile.write('  <font color="red">RED=TCP</font> &nbsp &nbsp <font color="blue">BLUE=UDP</font> &nbsp &nbsp <font color="green">GREEN=ICMP</font></br> \n')
...
for item in AllConnectionsSeen:
    ...
    if str(item.split(",")[4]) == "ICMP":
        ...
        fontcolor = "red"
    rightfile.write('<font color="' + fontcolor + '">' + RightStuff + '</br> \n')
...
for filename in filenames:
    ...
    writeHTMLfile.write('<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /> \n')
    writeHTMLfile.write('<meta http-equiv="Pragma" content="no-cache" /> \n')
    ...
    writeHTMLfile.write(" \n")
    writeHTMLfile.write('<script src="http://maps.googleapis.com/maps/api/js?libraries=geometry&key=YOURKEYGOESHERE"></script> \n')
    writeHTMLfile.write(" \n")
